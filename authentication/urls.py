...
urlpatterns = [
    ...
    path('email-verification/', EmailVerificationViewSet.as_view({'post': 'post'}), name='email_verification'),
    path("email-verification/resend/", EmailVerificationViewSet.as_view({"post": "resend"}), name="email_verification_resend"),
    path("login/", AuthViewSet.as_view({"post": "login"}), name="login"),
    path('profile/', AccountViewSet.as_view({"get": "retrieve", "patch": "partial_update"}), name="profile"),
    path("profile/my-competitions/", AccountViewSet.as_view({"get": "my_competitions"}), name="my_competitions"),
